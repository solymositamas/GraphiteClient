...
/**
 * The configuration screen for the [GraphiteAppWidget] AppWidget.
 */
class GraphiteAppWidgetConfigureActivity : Activity() {
    ...
    internal var mOnClickListener: View.OnClickListener = View.OnClickListener {
        val context = this@GraphiteAppWidgetConfigureActivity
...
//        updateAppWidget(context, appWidgetManager, mAppWidgetId)
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        setContentView(R.layout.graphite_app_widget_configure)
        ...
        mAppWidgetText.setText(loadTitlePref(this@GraphiteAppWidgetConfigureActivity, mAppWidgetId))
    }
